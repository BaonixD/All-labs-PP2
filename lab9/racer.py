...
background = pygame.image.load(r"D:\PP2\lab8\racer things\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"D:\PP2\lab8\racer things\Enemy.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"D:\PP2\lab8\racer things\coin.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"D:\PP2\lab8\racer things\player.png")
        self.rect = self.image.get_rect()
